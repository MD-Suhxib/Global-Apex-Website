        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Global Apex specializes in providing high-quality Raw and Finished granite solutions for your needa. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Bangalore, Karntaka</li>
              <li>India</li>
              <li>Email: info@globalapexs.com</li>
            </ul>
          </div>
        </div>
